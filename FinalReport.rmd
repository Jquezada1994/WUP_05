...
Drug users that got treated with the vaccine are less likely to get aids
...
colPerc(table1)
```
About 40% had the placebo vs women that took the vaccine 60%
...
The p-value = 7.686e-05 which is lower than 0.05 so I will reject the null hypothesis.This means there is data shows that the vaccine is effective within women if women get aids.
...
The p-value = 1.242e-07 which is lower than 0.05 so I will reject the null hypothesis.This means there is data shows that the vaccine is effective within drug users.
